...
import { APIConfigManager, APIConfig } from '../config/api';
...
export class AIService {
    ...
    public async generateCode(prompt: string, context: string = ''): Promise<AIResponse> {
        ...
        try {
            ...
            if (deepseekResponse) return deepseekResponse;
    ...
    private async callClaude(prompt: string, context: string, config: APIConfig): Promise<AIResponse | null> {
        try {
    ...
    private async callGPT(prompt: string, context: string, config: APIConfig): Promise<AIResponse | null> {
        try {
            const response = await axios.post(
    ...
    private async callDeepSeek(prompt: string, context: string, config: APIConfig): Promise<AIResponse | null> {
        try {
            const response = await axios.post(
    ...
    private async callGemini(prompt: string, context: string, config: APIConfig): Promise<AIResponse> {
        try {
            const response = await axios.post(
