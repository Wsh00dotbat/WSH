...
class ChatView {
    ...
    addMessage(content, role, fileReferences, codeBlocks) {
        this.messages.push({
            role,
            content,
            timestamp: new Date(),
